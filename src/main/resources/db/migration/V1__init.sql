...
(1, 'Tamil Prose & Poetry Comprehension', FALSE),
(1, 'Thirukkural & Classic Tamil Literature', FALSE),
(1, 'Tamil Vocabulary & Synonyms / Antonyms', FALSE),
(1, 'Tamil Sentence Correction & Fill in the Blanks', FALSE),
(1, 'Tamil Letter Writing & Composition', FALSE),
